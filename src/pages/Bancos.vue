...
export default {
  ...
  mounted () {
    ...
    let Nomeif = []
    let agencia = []
    this.$axios.get("https://olinda.bcb.gov.br/olinda/servico/Informes_Agencias/versao/v1/odata/Agencias?$top=550&$filter=UF%20eq%20'PA'&$orderby=NomeIf%20asc&$format=json&$select=NomeIf,NomeAgencia,Endereco,Numero,Bairro,Cep,Municipio,UF,DDD,Telefone").then(res => {
